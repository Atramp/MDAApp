 ...
 */
@WebServlet(name = "ListRules")
public class ListRules extends BaseServlet {
    Logger logger = LoggerFactory.getLogger((ListRules.class));
...
//    }
    ...
    protected String doService(SqlSession sqlSession, String keyMethod, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, MdaAppException {
        ...
        List<RuleFilter> list = operator.getRuleFilterByJobId(jobId);
        Gson gson = new Gson();
