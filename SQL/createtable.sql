...
alter table columns add enableResult integer not null default 1;
alter table columns add enableWhere integer not null default 1;
alter table columns add enableGroupBy integer not null default 1;
alter table columns add enableOrderBy integer not null default 1;
